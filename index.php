...
<body>
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="assets/images/adidas-y-3-2_f.png" class="d-block w-30" alt="...">
                        </div>
    ...
    <div class="container-fluid fill-prd-popular">
        <div class="row">
            <div class="col-2">
                <div class="Heading_cf">
                    <div class="ofertas_populares">
                        <span>OFERTAS</span>
                        <br>
                        <span class="sp-popular">POPULARES</span>
                    </div>
                </div>
                <svg class="ofertas_populares_svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="248" height="513" viewBox="0 0 248 513">
                    <g id="Heading" transform="translate(-1432.5 646) rotate(-90)">
                        <rect id="Bg" width="347" height="16" transform="translate(206 1485.5)" fill="#051026" />
                                ...
                                <div class="card card-prd">
                                    <div class="card-header card-precio">
                                        <div class="float-left titulo-card-precio">
                                            <span class="sp-titulo-precio-marca">ADIDAS</span>
                                            <br>
                                            <span>lalalal</span>
                                        ...
                                        <div class="card card-precio-2 float-right" style="width: 112px;">
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item list-group-item-precio list-group-item-precio-edit">An item</li>
                                                <li class="list-group-item list-group-item-precio">
                                                    <i class="far fa-paper-plane"></i>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <img class="card-img-top mx-auto d-block w-card-prd" src="assets/images/adidasFALCON.png" alt="Card image cap">
                                    <div class="card-body">
                                        <h5 class="card-title">Hombre, Hecho en China</h5>
                                    </div>
                                </div>
    ...
    <div class="container-fluid fill-prd-todos">

        <div class="row-titulo-escoge-tu-prd">
            <svg xmlns="http://www.w3.org/2000/svg" width="173" height="5" viewBox="0 0 173 5">
                <path id="line" d="M0,0H173V5H0Z" fill="#fff" />
            </svg>

            <span class="titulo-productos-todos">
                Escoge tu producto
            </span>
        </div>
        <div class="row">
